							...
							<div class="row">
								...
								*/
								...
								<div class="col-lg-4 col-md-5 col-sm-4 col-xs-12">
									<h5 class="widget-title title">CONTÁCTENOS</h5>
									<form method="post" class="form-horizontal contact-form" action="<?php bloginfo('template_directory')?>/php/contact/contact.php">
...
<!-- Honeypot SPAM Protection -->
										...
										<div class="form-group">
											<div class="col-md-12">
												<input type="text" name="cf[name]" class="form-control required" placeholder="* Nombre">
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-12">
										...
										<div class="form-group">
											<div class="col-md-12">
												<textarea name="cf[message]" rows="6" class="form-control required" placeholder="Mensaje"></textarea>
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-6">
								...
								<div class="col-lg-5 col-md-4 col-sm-5 col-xs-12">
									...
									<p>En <span style="font-weight: bold;">Red Design Systems </span> buscamos personas creativas, con iniciativa, responsables y orientadas al logro de los objetivos. Si crees que tienes lo necesario envíanos tu hoja de vida ahora mismo! </p>
									<a href="http://reddesignsystems.com/?page_id=172" class="btn btn-sm btn-primary btn-block" style="color: white;">Haz parte de Nuestro Equipo</a>
								</div>
